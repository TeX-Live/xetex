...
\usepackage[dvipdfm,colorlinks=true,urlcolor=blue,linkcolor=black]{hyperref}
...
\footnotesize
\hbox{\bf \XeTeX\ using an AAT font:}\vskip-20pt\null
\begin{verbatim}
> \box0=
...
\begin{minipage}[t]{0.5\hsize}
\footnotesize
\hbox{\bf \TeX\ (or \XeTeX) using a legacy font with {\tt .tfm} metrics:}\vskip-8pt\null
\begin{verbatim}
> \box1=
