%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ROHYPHEN.TEX, version 1.2 <2006-04-21>                %%
%% MODIFIED for Unicode/XeTeX: Jonathan Kew, 2006-04-21  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% ROHYPHEN.TEX 1.2 <21.04.2006>: Enhanced for XeTeX/Unicode
%
% -------------------------------------------------------------------
...
% -------------------------------------------------------------------
%
\message{Romanian Hyphenation Patterns: `rohyphen' 1.2 <21.04.2006>}
%
...
\ifx\XeTeXversion\undefined
  \def"#1{\ifx#1a^^a0\else \ifx#1A^^e2\else \ifx#1i^^ee\else
    ...
    \fi\fi\fi\fi\fi}
\else % for XeTeX, use Unicode codepoints
  \catcode`\?=\catcode`\^
  \def"#1{\ifx#1a^^e4\else \ifx#1A^^e2\else \ifx#1i^^ee\else
    \ifx#1s????015f\else \ifx#1t????0163\else
      \errmessage{Hyphenation pattern file corrupted!}%
    \fi\fi\fi\fi\fi}
\fi
%
