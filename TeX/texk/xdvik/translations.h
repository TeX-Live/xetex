...
/*     "Options|O > Fonts|F > Fonts Darker|D		:PUSH	:Alt-Ctrl-+	:change-density(25)\n" */
/*     "Options|O > Fonts|F > Fonts Lighter|L		:PUSH	:Alt-Ctrl--	:change-density(-25)\n" */
/* ---------- */
#if 0
...
/* ========== */
    ...
    "Help|H				:SEP	::\n"
    "Help|H > New Features in this Version|F:PUSH::load-url(http\\://xdvi.sourceforge.net/releases/" XDVI_VERSION ".html)\n"
...
/*     "Options:Show statusline:1 x:set-expert-mode(1)\n" */
    "Options:	SEP\n"
    "Options:	Fonts Darker:		Alt-Ctrl-+:	change-density(25)\n"
    "Options:	Fonts Lighter:		Alt-Ctrl--:	change-density(-25)\n"
    ...
    "Help:SEP\n"
    "Help:	New Features in this Version::	load-url(http\\://xdvi.sourceforge.net/releases/" XDVI_VERSION ".html)\n"
