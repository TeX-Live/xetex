/*  $Header: /home/cvsroot/dvipdfmx/src/cff.h,v 1.5 2004/01/30 11:31:30 hirata Exp $
...
typedef struct
{
  ...
  cff_index *_string;   /* Updated String INDEX */
} cff_font;
...
/* String */
extern int   cff_match_string (cff_font *cff, char *str, s_SID sid);
