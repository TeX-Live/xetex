/*  $Header: /home/cvsroot/dvipdfmx/src/dvi.c,v 1.17 2004/02/10 09:49:07 hirata Exp $
...
void dvi_do_special (Ubyte *buffer, UNSIGNED_QUAD size)
{
	  ...
	  ERROR("DVI file ended prematurely");
        ...
        if (strncmp(start, "landscape", 9) == 0)
          *landscape = 1;
          ...
          char *key, *val, *val_start = NULL, *val_end = NULL, *num;
          double unit;
