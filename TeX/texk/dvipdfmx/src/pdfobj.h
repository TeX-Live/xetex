/*  $Header: /home/cvsroot/dvipdfmx/src/pdfobj.h,v 1.9 2004/01/30 18:34:22 hirata Exp $
...
extern unsigned char *pdf_name_value (pdf_obj *object);
...
extern pdf_obj *pdf_new_name (const unsigned char *name);  /* Name does not include the / */
...
extern void pdf_add_stream (pdf_obj *stream,
			    const char *stream_data, unsigned length);
...
extern int pdfobj_escape_str (char *buffer, int size,
