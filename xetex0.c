...
zprintrawchar ( UTF16code s , boolean incroffset ) 
{
  ...
  {case 19 : 
    {
      if(s > 0x100) {
        fputwc ( (wchar_t) Xchr (s ),  stdout );
        fputwc ( (wchar_t) Xchr (s ),  logfile );
      } else {
        putc ( Xchr (s ),  stdout );
        putc ( Xchr (s ),  logfile );
      }
...
zprint ( integer s ) 
{
  ...
  j = strstart [( s ) - 65536L ];
  while ( j < strstart [( s + 1 ) - 65536L ]) if ( ( strpool [j ]>= 55296L 
  ) && ( strpool [j ]<= 57343L ) ) 
  {
    if ( ( strpool [j ]<= 56319L ) && ( j + 1 < strstart [( s + 1 ) - 
    65536L ]) && ( strpool [j + 1 ]>= 56320L ) && ( strpool [j + 1 ]<= 
    57343L ) ) 
    {
...
zflushnodelist ( halfword p ) 
{
  ...
  while ( p != -268435455L ) {
      ...
      case 8 : 
	{
	  ...
	  case 42 : 
	  case 43 : 
	    freenode ( p , ( 8 + ( mem [p + 4 ].hh.b0 + sizeof ( memoryword 
	    ) - 1 ) / sizeof ( memoryword ) ) ) ;
	    break ;
	  case 6 : 
	    freenode ( p , 2 ) ;
...
zcopynodelist ( halfword p ) 
{
  ...
  while ( p != -268435455L ) {
	...
	break ;
      ...
      case 43 : 
	{
	  words = ( 8 + ( mem [p + 4 ].hh.b0 + sizeof ( memoryword ) - 1 ) / 
	  sizeof ( memoryword ) ) ;
	  r = getnode ( words ) ;
	} 
	break ;
...
zprintcmdchr ( quarterword cmd , halfword chrcode ) 
{
  ...
  case 21 : 
    if ( chrcode == 1 ) 
    printesc ( 66442L ) ;
    else printesc ( 66443L ) ;
    break ;
  case 22 : 
    if ( chrcode == 1 ) 
    printesc ( 66444L ) ;
    else printesc ( 66445L ) ;
    break ;
  case 20 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 31 : 
    ...
    printesc ( 66453L ) ;
    else printesc ( 66450L ) ;
    break ;
  case 43 : 
    if ( chrcode == 0 ) 
    printesc ( 66470L ) ;
    else printesc ( 66469L ) ;
    break ;
  case 25 : 
    if ( chrcode == 10 ) 
    printesc ( 66482L ) ;
  ...
  case 99 : 
    ...
    printesc ( 66569L ) ;
    else printesc ( 66570L ) ;
    break ;
  case 96 : 
    if ( chrcode != 0 ) 
    printesc ( 66588L ) ;
    else printesc ( 66587L ) ;
    break ;
  case 97 : 
    switch ( chrcode ) 
    {case 0 : 
  ...
  case 60 : 
    if ( chrcode == 0 ) 
    printesc ( 66643L ) ;
    else printesc ( 66642L ) ;
    break ;
  case 58 : 
    if ( chrcode == 0 ) 
    printesc ( 66644L ) ;
    else printesc ( 66645L ) ;
    break ;
  case 57 : 
    if ( chrcode == 3368180L ) 
    printesc ( 66651L ) ;
...
openlogfile ( void ) 
{
  ...
  logopened = true ;
  {
    ...
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99992" ) ;
    else
    fprintf ( logfile , "%s%s%s",  "This is XeTeX, Version 3.14159265" , "-2.6" ,     "-0.99992" ) ;
...
zoutwhat ( halfword p ) 
{
  ...
  case 2 : 
	...
	else if ( j < 16 ) 
	{
	  ...
	  aopenout ( writefile [j ]) ) promptfilename ( 66742L , 66138L ) ;
	  writeopen [j ]= true ;
	  if ( logopened ) 
	  {
	    oldsetting = selector ;
...
hlistout ( void ) 
{
  ...
  while ( p != -268435455L ) {
	...
	lab1237: if ( p != r ) 
	{
	  ...
	  lab30: q = newnativewordnode ( mem [r + 4 ].qqqq .b1 , ( poolptr - 
...
zshipout ( halfword p ) 
{
  ...
  synctexsheet ( eqtb [8938757L ].cint ) ;
  {
    ...
    if ( outputfilename == 0 ) 
    {
      ...
      while ( ! dviopenout ( dvifile ) ) promptfilename ( 66142L , 
      outputfileextension ) ;
...
zscanspec ( groupcode c , boolean threecodes ) 
{
  ...
  if ( scankeyword ( 66205L ) ) 
  speccode = 0 ;
  else if ( scankeyword ( 66206L ) ) 
  speccode = 1 ;
  else {
...
begininsertoradjust ( void ) 
{
  ...
  if ( ( curcmd == 38 ) && scankeyword ( 66476L ) ) 
...
mathac ( void ) 
{
  ...
  if ( curchr == 1 ) 
  {
    if ( scankeyword ( 66529L ) ) 
    mem [curlist .tailfield ].hh.b1 = 1 ;
    else if ( scankeyword ( 66530L ) ) 
    {
      if ( scankeyword ( 66529L ) ) 
...
zloadpicture ( boolean ispdf ) 
{
  ...
  if ( ispdf ) 
  {
    if ( scankeyword ( 66383L ) ) 
    {
      scanint () ;
      page = curval ;
    } 
    pdfboxtype = 1 ;
    if ( scankeyword ( 66747L ) ) 
    ;
    else if ( scankeyword ( 66748L ) ) 
    pdfboxtype = 2 ;
    else if ( scankeyword ( 66749L ) ) 
    pdfboxtype = 3 ;
    else if ( scankeyword ( 66750L ) ) 
    pdfboxtype = 4 ;
    else if ( scankeyword ( 66751L ) ) 
    pdfboxtype = 5 ;
  } 
  result = findpicfile ( addressof ( picpath ) , addressof ( bounds ) , 
  pdfboxtype , page ) ;
  ...
  if ( result == 0 ) 
  {
    newwhatsit ( 42 , 8 + ( strlen ( picpath ) + sizeof ( memoryword ) - 1 ) / 
    sizeof ( memoryword ) ) ;
    if ( ispdf ) 
    {
    ...
    memcpy ( addressof ( mem [curlist .tailfield + 8 ]) , picpath , strlen ( 
    picpath ) ) ;
    libcfree ( picpath ) ;
  } 
  else {
